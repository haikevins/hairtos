...
if "Current status: Phase 7 complete" not in readme:
    print("README no longer identifies Phase 7 as the current completed phase")
    sys.exit(1)
...
print("Current implementation phase: Phase 7")
