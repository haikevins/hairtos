...
if "Current status: Phase 9 complete" not in readme:
    print("README no longer identifies Phase 9 as the current completed phase")
    sys.exit(1)
...
print("Current implementation phase: Phase 9")
