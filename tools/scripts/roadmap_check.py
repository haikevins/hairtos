...
if "Current status: Phase 5 complete" not in readme:
    print("README no longer identifies Phase 5 as the current completed phase")
    sys.exit(1)
...
print("Current implementation phase: Phase 5")
