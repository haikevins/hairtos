...
if "Current status: Phase 6 complete" not in readme:
    print("README no longer identifies Phase 6 as the current completed phase")
    sys.exit(1)
...
print("Current implementation phase: Phase 6")
