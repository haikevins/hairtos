...
- Migration must be incremental: run v1 workloads on the v2 core first, then opt into HSM/tickless/trace capabilities.
- Static object ownership and existing task/IPC semantics should be preserved to minimize churn.
- Behavioral changes must include a before/after table and matching tests.
