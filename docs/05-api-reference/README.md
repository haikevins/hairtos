...
| Document | Role |
| --- | --- |
| [`diagnostics-and-hooks-api.md`](diagnostics-and-hooks-api.md) | Diagnostics and Hooks API |
| [`haievent-api.md`](haievent-api.md) | haievent API |
| [`kernel-and-task-api.md`](kernel-and-task-api.md) | Kernel and Task API |
| [`mutex-api.md`](mutex-api.md) | Mutex API |
| [`public-api-policy.md`](public-api-policy.md) | Public API policy |
| [`queue-api.md`](queue-api.md) | Queue API |
| [`semaphore-api.md`](semaphore-api.md) | Semaphore API |
| [`status-and-types.md`](status-and-types.md) | Status and Data Types |
| [`time-and-context-api.md`](time-and-context-api.md) | Time and Context API |
| [`timer-api.md`](timer-api.md) | Software Timer API |
