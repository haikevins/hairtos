...
if "Current status: Phase 8 complete" not in readme:
    print("README no longer identifies Phase 8 as the current completed phase")
    sys.exit(1)
...
print("Current implementation phase: Phase 8")
