...
```text
build/00-baremetal-blink/hairtos_baremetal.elf
build/00-baremetal-blink/hairtos_baremetal.bin
build/00-baremetal-blink/hairtos_baremetal.hex
build/00-baremetal-blink/hairtos_baremetal.map
```
