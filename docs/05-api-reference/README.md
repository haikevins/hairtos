...
| Tài liệu | Vai trò |
| --- | --- |
| [`diagnostics-and-hooks-api.md`](diagnostics-and-hooks-api.md) | Diagnostics và Hooks API |
| [`haievent-api.md`](haievent-api.md) | haievent API |
| [`kernel-and-task-api.md`](kernel-and-task-api.md) | Kernel và Task API |
...
| [`status-and-types.md`](status-and-types.md) | Status và kiểu dữ liệu |
| [`time-and-context-api.md`](time-and-context-api.md) | Time và Context API |
